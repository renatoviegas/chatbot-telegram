...
const contato = Markup.keyboard([
    Markup.contactRequestButton('Clique aqui para enviar seu contato')
]).resize().oneTime().extra()
...
bot.on('contact', async ctx => {
    ...
    console.log(contact)
    ctx.reply(`Uooopa!!! >  
        ${contact.first_name} (${contact.phone_number})`, tecladoOpcoes)
})
